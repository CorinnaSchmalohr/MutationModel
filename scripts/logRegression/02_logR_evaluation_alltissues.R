...
lapply(tissues, function(tissue){  
  ...
  data_plot_AUC_ratio <- data.frame(mutation_ratio[3,], AUROC_CV)
  names(data_plot_AUC_ratio) <- c("ratio", "AUC")
  ...
  png(filename = paste0(path_fig, "/ROC_PR_mutRatio_CV_",tissue,".png"), width = 720*2, height = 720*2, pointsize = 22)
