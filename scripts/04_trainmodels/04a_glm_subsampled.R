...
predictions = lapply(chroms, function(cr){
  ...
  save(logR, file = paste0("data/rdata/GLMmodel/", tissue, "_subsampled_", cr, ".RData"))
  ...
  logR = glm(formula = mutated ~ ., data = trainData, 
             family = binomial(link = "logit"))
  save(logR, file = paste0("data/rdata/GLMmodel/", tissue, "_subsampled_", cr, "_sig.RData"))
...
save(predictions, file = paste0("data/rdata/GLMmodel/", tissue,
                                "_predictions_subsampled_sig.RData"))
cat('\n')
...
save(feature_selection, file = paste0("data/rdata/GLMmodel/", tissue,"_CWCV_subsampled_feature_selection.RData"))
cat('\n')
#####
...
save(logR, file = paste0("data/rdata/GLMmodel/", tissue, "_subsampled.RData"))
...
save(logR, sigFreatures, file = paste0("data/rdata/GLMmodel/", tissue, "_subsampled_sig.RData"))
#####
...
#    cat(cr, ' ')
#    load(paste0("data/rdata/GLMmodel/", tissue, "_subsampled_", cr, ".RData"))
#    return(logR$coefficients)
#  })
#  save(imp, file = paste0("data/rdata/GLMmodel/", tissue,"_importances_subsampled.RData"))
#  cat('\n')
#  
...
#  imp = sapply(chroms, function(cr){
#    cat(cr, ' ')
#    load(paste0("data/rdata/GLMmodel/", tissue, "_subsampled_", cr, "_sig.RData"))
#    return(logR$coefficients)
#  })
#  save(imp, file = paste0("data/rdata/GLMmodel/", tissue,"_importances_subsampled_sig.RData"))
#  cat('\n')
#  
#  # predict on held-out chromosomes
#  print("predictions")
