...
Rscript  --vanilla --verbose scripts/data_preparation/all_tissues/01a_createBins.R
...
scripts/data_preparation/all_tissues/03d4_DNAaccessibilityBinWise.sh
Rscript --vanilla --verbose  \
   scripts/data_preparation/all_tissues/03d5_DNAaccessibilityBinWise.R
...
scripts/data_preparation/all_tissues/03e3_DNAmethylation_binWise.sh
Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/03e4_DNAmethylation_binWise.R
...
scripts/data_preparation/all_tissues/03f4_GCcontent_binWise.sh
Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/03f5_GCcontent_binWise.R
...
scripts/data_preparation/all_tissues/03g5_DNAbinding_binWise.sh
Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/03g6_DNAbinding_binWise.R
...
scripts/data_preparation/all_tissues/03l3_nucleosome_perBin.sh
Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/03l4_nucleosome_perBin.R
...
Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/03n_binWise.R

echo 'prepare dataframe'
for n in $(seq 1 7); do Rscript --vanilla --verbose \
   scripts/data_preparation/all_tissues/04_prepareDataframe_withBinWise.R $n; done
