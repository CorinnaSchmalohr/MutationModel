...
subTrain = sapply(tissues, function(tissue2predict){
  ...
  perfs = sapply(tissues, function(predictingTissue){
    ...
    load(paste0("data/rdata/GLMmodel/", predictingTissue, "_subsampled_", cr, "_sig.RData"))
    load(paste0("data/procData/traindata/traindata_processed_",
                predictingTissue, "_subsampled.RData"))
    
    # Just transfer on the sig. predictors
    load(file = paste0("data/rdata/GLMmodel/", predictingTissue,"_pvals_subsampled.RData"))
...
save(subTrain, file = "data/rdata/GLMCrossTissue_subTrain.RData")
#####
...
save(subTest, file = "data/rdata/GLMCrossTissue_subTest.RData")
#####
...
save(subBoth, file = "data/rdata/GLMCrossTissue_subBoth.RData")
#####
